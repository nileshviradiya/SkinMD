    ...
    $['selectBox'] = {
        ...
        setDropDownValue: function(elID, value,div) {
            ...
            if(!el.getAttribute("multiple")){
                ...
                var idnn = el.selectedIndex;
                // alert($(el ).val);
                // alert("element "+ $(el[value=idnn]).text());
                 document.getElementById(elID+"_jqmobiSelect").innerHTML = '<span class="prego">'+$(el[value]).text()+'</span>';
            ...
            this.hideDropDown();
                ...
                document.getElementById(elID+"_jqmobiSelect").innerHTML = '<span class="prego">'+count  +' elements</span>';
        ...
        */
        ...
        showModal: function(id) {
            ...
            try {
            	//alert('id :'+ id);
                if($am(id)) {
                	//alert('id :'+ $.feat.nativeTouchScroll);
                    //$("#modalContainer").html($.feat.nativeTouchScroll ? $am(id).innerHTML+'<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>' : $am(id).childNodes[0].innerHTML + '', true);
                	  if($.feat.nativeTouchScroll)
                      { $("#modalContainer").html($am(id).innerHTML);
                      }
                      else
                      {
                      	$("#modalContainer").html($am(id).childNodes[0].innerHTML);
                      }	
                	$('#modalContainer').append($am(id).innerHTML + "<a style='z-index:9999' href='javascript:;' onclick='$.ui.hideModal();' class='closebutton modalbutton'></a>");
// alert($am(id).innerHTML);
// alert($am(id).childNodes[0].innerHTML); 
        ...
        hideModal: function() {
          ...
          //  this.scrollingDivs['#modalContainer'].disable();
