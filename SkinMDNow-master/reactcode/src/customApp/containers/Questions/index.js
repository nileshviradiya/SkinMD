...
class Questions extends Component {
  ...
  handleDelete = key => {
    const { deleteQuestions } = this.props;
    deleteQuestions(key);
  }
  ...
  render() {
    ...
    const columnsPro = [
      ...
      }, 
      {
        ...
        ...this.getColumnSearchProps('display_order'),
      }, 
      {
        title: 'Status',
        dataIndex: 'status',
      ...
      },
      {
        ...
        dataIndex: 'actions',
        key: 'actions',
        render: (text,questions_list) => (
            <div className="isoInvoiceBtnView">
              <Link to={`${'questions'}/${questions_list.key}`}>
                <Button color="primary" className="skincaseViewBtn">
                  View
                </Button>
              </Link>{' '}
              <Popconfirm title="Sure to delete?" onConfirm={() => this.handleDelete(questions_list.key) }>            
                <Button
    ...
    const { questions_list, deleteQuestions } = this.props;
      ...
      selections: [
        {
          ...
          onSelect: () =>
            this.setState({
              selected: this.props.questions_list.map(question => question.key),
            }),
        },
        {
          key: 'no-data',
