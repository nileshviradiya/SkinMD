...
class ActiveCase extends Component {
    ...
    handleDelete = key => {
        const { deleteSkincase, initData } = this.props;
    ...
    /**--------- */
    render() {
        const { cType, skincases, deleteSkincase, initData } = this.props;
        ...
        return (
            <Box>
                <div className="isoInvoiceTableBtn" style={(cType == 'single' ? divStyle : divStyleBlock)}>
